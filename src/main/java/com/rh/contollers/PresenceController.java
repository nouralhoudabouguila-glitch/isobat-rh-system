    ...
    private void setupColumns() {
        ...
        colHeures.setCellFactory(col -> new TableCell<>() {
            @Override protected void updateItem(String v, boolean empty) {
                ...
                if (empty || v == null) { setText(null); return; }
                setText(v);
                setStyle("-fx-font-family:'Poppins';-fx-font-size:12;-fx-font-weight:bold;-fx-text-fill:#4F6815;-fx-alignment:CENTER;");
        ...
        colSource.setCellFactory(col -> new TableCell<>() {
            @Override protected void updateItem(String v, boolean empty) {
                ...
                setStyle("-fx-font-family:'Poppins';-fx-font-size:11;-fx-text-fill:" + color + ";-fx-font-weight:bold;");
            }
        });
    ...
    private void handleImporter() {
        ...
        if (fichier != null) {
            ...
            deptDialog.showAndWait().ifPresent(deptStr -> {
                Departement dept = "TOUS".equals(deptStr) ? null : Departement.valueOf(deptStr);
